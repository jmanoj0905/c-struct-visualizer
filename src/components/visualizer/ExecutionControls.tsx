...
const ExecutionControls = () => {
  ...
  return (
    <div className="absolute bottom-14 left-1/2 -translate-x-1/2 z-10 flex items-center gap-2 bg-white border-2 border-black rounded-base shadow-shadow px-3 py-2">
      <button
        onClick={goFirst}
        disabled={atFirst}
